...
class AppLocalization {
  ...
  factory AppLocalization.of(BuildContext context) => Localizations.of<AppLocalization>(context, AppLocalization)!;
  ...
  Future<void> load() async {
    final String jsonString = await rootBundle.loadString("lang/$_languageCode.json");
